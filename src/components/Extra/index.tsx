        ...
        <div className="row justify-content-center align-items-center mb-4 mt-5">
            <div className="col-md-4 ">
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <a href="/numero" className="btn btn-primary">Go somewhere</a>
                    </div>
                </div>
            </div>
            ...
            <div className="col-md-4">
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">Some quick example text to build on the card title and make up
                            the bulk of the card's content.</p>
                        <a href="/nome" className="btn btn-primary">Go somewhere</a>
                    </div>
                </div>
            </div>
            ...
            <div className="col-md-4">
                <div className="card">
                    ...
                    <div className="card-body ">
                        <h5 className="card-title">Encontrou algum problema nos sorteios? Entre em contato o
                            suporte</h5>
                        <p className="card-text">Some quick example text to build on the card title and make up
                            the bulk of the card's content.</p>
